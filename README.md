...
Note: the RINs have been constructed based on the contact maps; the red bar in Fig C (persistent interactions in Nvjp-1) comes from the consecutive residues that are connected by the peptide bonds.
